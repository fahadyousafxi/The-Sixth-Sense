            ...
            if (controller.booking.value.address == null)
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(controller.booking.value.salon.name, style: Get.textTheme.bodyText1),
                    SizedBox(height: 8),
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Obx(() {
                            return Column(
                              ...
                              children: [
                                Text(controller.booking.value.salon.address.address, style: Get.textTheme.bodyText2),
                              ],
                            );
                          }),
                        ),
                            ...
                            return Column(
                              ...
                              children: [
                                if (controller.booking.value.address.hasDescription())
                                  Text(controller.booking.value.address?.getDescription ?? "Loading...".tr, style: Get.textTheme.subtitle2),
                                if (controller.booking.value.address.hasDescription()) SizedBox(height: 10),
                                Text(controller.booking.value.address?.address ?? "Loading...".tr, style: Get.textTheme.bodyText2),
                              ],
                            );
                          }),
                        ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Obx(() {
                            return Text(controller.booking.value.hint, style: Get.textTheme.bodyText2);
                          }),
                        ),
                      ],
                    ),
